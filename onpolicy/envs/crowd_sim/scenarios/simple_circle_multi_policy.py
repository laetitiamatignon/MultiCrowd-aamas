...
from onpolicy.envs.crowd_sim.crowd_nav.policy.social_force import SOCIAL_FORCE
...
class Scenario(BaseScenario):
    ...
    def observation(self, id, world):
        ...
        # size of one row (one entity) = positions + visibility (1) + label (num of type)
