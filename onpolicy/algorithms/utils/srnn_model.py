...
class RNNBase(nn.Module):
    ...
    def __init__(self, args, edge):
        ...
        if edge:
            self.gru = nn.GRU(args.DSRNN_human_human_edge_embedding_size, args.DSRNN_human_human_edge_rnn_size)
        # if this is a node RNN
        else:
            self.gru = nn.GRU(args.DSRNN_human_node_embedding_size*2, args.DSRNN_human_node_rnn_size)
